...
namespace Metanoia.Tools
{
    ...
    public class TPL : IDisposable
    {
        ...
        public static Bitmap ConvertFromTextureMelee(byte[] imageData, int width, int height, int form, byte[] paletteData, int count, int paletteFormat)
        {
            TPL tmpTpl = new TPL();
            Bitmap output;
            TPL_TextureFormat format = (TPL_TextureFormat)form;
        ...
        public static int textureByteSize(TPL_TextureFormat tplFormat, int width, int height)
        {
            switch (tplFormat)
            {
                case TPL_TextureFormat.I4:
